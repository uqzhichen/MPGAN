...
from models import _netD, _netG,_param, LINEAR_LOGSOFTMAX, weights_init
    ...
    for it in range(start_step, 3000+1):
        ...
        for _ in range(5):
            ...
            for part in range(parts):
                ...
                grad_penalty = calc_gradient_penalty(opt.batchsize, netDs[part], X.data[:, part*512:(part+1)*512], G_sample.data, opt.GP_LAMBDA)
